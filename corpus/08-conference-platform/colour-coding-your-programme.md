...
[Selecting colours](#SEL)

[Colouring your sessions](#COL)

[Applying colour by track or presentation type](#APP)
...
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-2893753f.webp)   
...
![](/assets/img/undefined-apr-08-2021-02-44-16-05-pm-a68caa0c.webp)  
  

Pick your chosen colour by clicking on it. The paint bucket icon will change to your chosen colour.

![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-b5bebecb.webp)   

**The palette**

This tool will allow you to select custom colours.

![](/assets/img/undefined-apr-08-2021-02-45-19-56-pm-01c0e224.webp)

Click on the icon, and then in the bar shown below.

  
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-3eda7f2a.webp)   
...
![](/assets/img/undefined-apr-08-2021-02-47-41-09-pm-0cba4556.webp)

Your chosen colour will appear in the bar, and the paint bucket icon. You can then apply the colour to a session.

![](/assets/img/undefined-apr-08-2021-02-50-30-15-pm-03d45862.webp)  

#### **The pipette**

  

![](/assets/img/undefined-apr-08-2021-02-51-13-91-pm-bbbdbd75.webp)
...
NB: If you have coloured your sessions according to track or presentation type [(see below)](#APP), the colour will be locked and you will not be able to change the colour.

![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-cfe38849.png)   

#### **Session selection**

  

![](/assets/img/undefined-apr-08-2021-02-55-34-69-pm-7ca87025.webp)
...
![](/assets/img/undefined-apr-08-2021-02-59-52-71-pm-28c1846a.webp)

The commands are in the lower part of the panel.

  
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-6465e4b0.png)   
...
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-157c6108.png)   
...
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-cdb42caa.png)  

Similarly, if you have applied colour according to **presentation type**, and you decide you would like to apply the colour according to track, click**USE TRACK COLOUR.**(See below for instructions on setting colours for tracks and presentation types.)
...
NB: To set up tracks, see [Setting up your program - configuration](/08-conference-platform/setting-up-your-program-configuration)
...
![](/assets/img/undefined-apr-08-2021-03-08-58-95-pm-9a68eb70.webp)

and choose **Pick track colours**

**![](/assets/img/undefined-apr-08-2021-03-09-54-73-pm-8d76d5a6.webp)**

The **Track colour selection** panel will open up

![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-c25ef170.webp)   
...
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-f4bba05f.webp)

Your tracks will then be coloured accordingly.

  
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-6d33ca57.webp)   
...
![](/assets/img/undefined-apr-08-2021-03-12-00-86-pm-1c8dda19.webp)
