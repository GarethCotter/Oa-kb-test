---
title: "Comments on sessions and abstracts"
section: "08-conference-platform"
audience: organisers
plan: professional conference
source_url: https://help.oxfordabstracts.com/knowledge/advanced/-virtual-conference-program-user-comments
...
![](/assets/img/undefined-oct-14-2021-02-44-28-97-pm-af942a7d.webp)
...
**[Enabled](#EN) -**(users can comment)

**[Disabled - show existing comments](#DIS)**(all comments will be displayed but no new comments permitted)

[**Disabled -**](#DIS2)**[hide existing comments](#DIS2)**(no comments displayed or permitted)

![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-1f27b116.webp)   

**Enabled**

When this is set, the user's view is as below. They can either reply to an existing comment, or post a new comment.

![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-89a8902a.webp)   

**Disabled - show existing comments**

When this is set, the user's view is as below.

![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-f65faf6e.webp)   
...
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-4828e5cd.webp)
...
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-2b7e5a41.webp)   

Click the up arrow to hide this session's comments when you are done.

![](/assets/img/undefined-apr-08-2021-12-11-49-41-pm-6b658cdd.webp)![](/assets/img/oxfordabstracts-freshdesk-comsupportsolutionsarticles8000088-de758485.gif)
