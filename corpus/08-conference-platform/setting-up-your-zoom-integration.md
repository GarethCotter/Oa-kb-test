---
title: "Setting up your Zoom integration"
section: "08-conference-platform"
audience: organisers
plan: standard conference
source_url: https://help.oxfordabstracts.com/knowledge/setting-up-your-zoom-integration-coming-soon
...
#### [Connecting Zoom to sessions](#CON)

#### [Assigning columns to users](#ASS)

#### [Editing Zoom details](#EDI)

#### [Removing a Zoom link from a session](#REM)

#### [Removing a Zoom account](#REMA)
...
![](/assets/img/image-png-sep-14-2021-10-01-47-18-am-fef69d77.webp)
...
![](/assets/img/image-png-sep-14-2021-10-19-12-49-am-03578e37.webp)
...
This shows the columns you have set up on the [program builder](/08-conference-platform/setting-up-your-program-configuration) and the member of the Zoom account to which they have been allocated. You can only allocate one user to one column.

You can use the dropdown to change the allocation.

Once you are happy with the allocated users you can [start linking Zoom to your program sessions.](#CON)
...
![Image showing the Zoom integration page in Oxford Abstracts after the connection has completed](/assets/img/image-png-sep-14-2021-10-30-37-99-am-adf4c2df.webp)
...
![](/assets/img/image-png-sep-14-2021-10-39-28-42-am-bc68284d.webp)
...
![](/assets/img/image-png-sep-14-2021-10-42-57-93-am-5e6031a3.webp)
...
![](/assets/img/image-png-sep-20-2021-07-27-34-81-am-ed057f89.webp)

The button appears within each session popup.

![](/assets/img/image-png-sep-14-2021-10-49-59-04-am-6146d824.webp)
...
![](/assets/img/image-png-sep-20-2021-07-22-21-91-am-473eb8e5.webp)

Once you are happy with the details in the set up, click **Update** to save it to your session.

![](/assets/img/image-png-sep-20-2021-07-22-01-65-am-757bd41a.webp)
...
![](/assets/img/image-png-sep-20-2021-07-21-11-74-am-61632a8d.webp)
...
![Image showing the Zoom integration page in Oxford Abstracts after the connection has completed](/assets/img/image-png-sep-14-2021-10-30-37-99-am-86dad3f4.webp)
