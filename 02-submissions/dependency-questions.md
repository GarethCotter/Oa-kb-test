...
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-9932f5e1.webp)  
...
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-4640565e.webp)  
...
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-44d93787.webp)

3) Click on the display settings to the right of the **parent** question and check **Dependency question**

  

![](/assets/img/undefined-jan-27-2022-03-46-32-88-pm-afb61826.webp)
...
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-d2aae953.webp)  
...
Choose the responses) (2) that when selected, will reveal this child question. Click OK to save your choices and return to the edit form view.![](/assets/img/undefined-feb-23-2021-04-06-29-65-pm-f2188335.webp)

  

5. You will see that the line between the parent and child questions has turned green (red), signifying that the link is now set up. You can then set up the second child question (green), if required (if you require a different question to be revealed for a different response), using the method above.

  
![](/assets/img/s3-amazonaws-comcdn-freshdesk-comdatahelpdeskattachmentsprod-8d4720a0.webp)

6. Click Preview at the top of the form to test your dependency questions.

  

NB: If you move the order of the questions, the parent / child links will break.

![](/assets/img/oxfordabstracts-freshdesk-comsupportsolutionsarticles8000086-a4cf8106.gif)
